  ...
  componentDidMount() {
    ...
    if (this.props.api_response && this.props.api_response.ok) {
      if (this.props.method_type === 'PUT') {
        toast.success('Employee record has been updated successfully', {
          position: toast.POSITION.TOP_RIGHT,
        });
      } else if (this.props.method_type === 'POST') {
        toast.success('Employee record has been created successfully', {
          position: toast.POSITION.TOP_RIGHT,
        });
      }
    }
      ...
      <div className="background-image">
        ...
        <div className="bootstp-table">
          ...
          >
            ...
            <TableHeaderColumn dataField="ibm_email" width="270">
              IBM EmailID
            </TableHeaderColumn>

            <TableHeaderColumn dataField="nationwide_email" width="270">
              Nationwide EmailID
            </TableHeaderColumn>

            <TableHeaderColumn dataField="emptype" width="100">
              Employee Type
            </TableHeaderColumn>
            
            <TableHeaderColumn dataField="contract" width="90">
              Contract/Services (Test Services or DCDG)
            </TableHeaderColumn>
